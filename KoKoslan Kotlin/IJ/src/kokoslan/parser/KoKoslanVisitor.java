...
public interface KoKoslanVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link KoKoslanParser#fail_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFail_expr(KoKoslanParser.Fail_exprContext ctx);
	/**
	 * Visit a parse tree produced by {@link KoKoslanParser#cons_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCons_expr(KoKoslanParser.Cons_exprContext ctx);
	/**
	 * Visit a parse tree produced by {@link KoKoslanParser#primitive_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrimitive_expr(KoKoslanParser.Primitive_exprContext ctx);
	/**
	 * Visit a parse tree produced by {@link KoKoslanParser#primitive_oper}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrimitive_oper(KoKoslanParser.Primitive_operContext ctx);
	/**
	 * Visit a parse tree produced by {@link KoKoslanParser#not_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNot_expr(KoKoslanParser.Not_exprContext ctx);
	/**
	 * Visit a parse tree produced by {@link KoKoslanParser#bool_statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBool_statement(KoKoslanParser.Bool_statementContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link KoKoslanParser#logic_oper}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLogic_oper(KoKoslanParser.Logic_operContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link KoKoslanParser#lambda_eval}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLambda_eval(KoKoslanParser.Lambda_evalContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link KoKoslanParser#tern_oper}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTern_oper(KoKoslanParser.Tern_operContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code PrimitiveValueExpr}
	 * labeled alternative in {@link KoKoslanParser#value_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrimitiveValueExpr(KoKoslanParser.PrimitiveValueExprContext ctx);
	/**
